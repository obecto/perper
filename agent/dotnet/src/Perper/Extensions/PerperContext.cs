...
namespace Perper.Extensions
{
    public static class PerperContext
    {
        ...
        public static Task<PerperAgent> StartAgentAsync(string agent, params object[] parameters) => AsyncLocalContext.PerperContext.Agents.CreateAsync(agent, parameters);

        public static Task<(PerperAgent agent, TResult result)> StartAgentAsync<TResult>(string agent, params object[] parameters) => AsyncLocalContext.PerperContext.Agents.CreateAsync<TResult>(agent, parameters);
