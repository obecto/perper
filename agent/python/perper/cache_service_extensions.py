...
def perper_stream_add_listener(cache_service, perper_stream, caller_agent, caller, parameter):
    return cache_service.stream_add_listener(perper_stream.stream, caller_agent, caller, parameter, perper_stream.filter, perper_stream.replay, perper_stream.local_to_Data)
