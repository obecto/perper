...
def create_query_entity(key_type_name=None, value_type_name=None, query_fields=[], query_indexes=[], /, table_name=None, key_field_name=None, value_field_name=None, field_name_aliases=[]):
    return {
...
def create_query_field(name, type_name, *, is_key_field=False, is_notnull_constraint_field=None, default_value=None, precision=-1, scale=-1):
    return dict(name=name, type_name=type_name, is_key_field=is_key_field, is_notnull_constraint_field=is_notnull_constraint_field, default_value=default_value, precision=precision, scale=scale)
