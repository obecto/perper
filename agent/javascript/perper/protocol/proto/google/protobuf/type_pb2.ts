...
import { Any } from "./any_pb2";
import { SourceContext } from "./source_context_pb2";
...
export const Type = {
  ...
  toJSON(message: Type): unknown {
    ...
    message.sourceContext !== undefined &&
      (obj.sourceContext = message.sourceContext ? SourceContext.toJSON(message.sourceContext) : undefined);
