...
_perper_utils_folder = os.path.abspath(os.path.join(_root_dir, "../../DotnetUtils/PerperUtils/bin/Debug/net6.0/"))
sys.path.append(_perper_utils_folder)
_dotnet_agent_dll_folder = os.path.abspath(os.path.join(_root_dir, "../../DotnetUtils/DllDump/bin/Debug/net6.0/"))
